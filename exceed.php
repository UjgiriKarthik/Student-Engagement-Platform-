...
$search_query = '';
if (isset($_GET['query'])) {
    $search_query = $data->real_escape_string($_GET['query']);
}
...
$query = "SELECT Exceed1.id AS question_id, Exceed1.question, Answers.answer_id, Answers.answer, Answers.image_path,
          ...
          WHERE Exceed1.question LIKE '%$search_query%' OR Answers.answer LIKE '%$search_query%'
...
<body>
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
        <form class="d-flex mx-auto form-mid pt-3" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
            ...
            <div class="row">
                ...
                <div class="text-card heading3">
                    ...
                    <div class="text-card heading3 pb-4">
                        ...
                        foreach ($questions as $id => $question) {
                            if (isset($answer_counts[$id]) && $answer_counts[$id] == 0) { 
                                $progress_found = true;
                ...
                <div id="FAQsection" class="col-12 col-xl-8">
                    ...
                    <div class="text-card heading3">
                        ...
                        foreach ($questions as $id => $question) {
                            if (isset($answer_counts[$id]) && $answer_counts[$id] > 2) { 
                                ...
                                echo '<span onclick="handleEmojiClick(' . $first_answer['answer_id'] . ', \'heart\')">❤️</span> <span id="heart-' . $first_answer['answer_id'] . '">' . $first_answer['heart'] . '</span>';
                                echo '</div>';
                                ...
                                if (count($question['answers']) > 1) {
                                    ...
                                    for ($i = 1; $i < count($question['answers']); $i++) {
                                        ...
                                        echo '<span onclick="handleEmojiClick(' . $answer['answer_id'] . ', \'heart\')">❤️</span> <span id="heart-' . $answer['answer_id'] . '">' . $answer['heart'] . '</span>';
                                        echo '</div>';
                                    }
                                    echo '</div>';
                    ...
                    <div class="shadow main-card1 pt-3">
                    <div class="col-12">
                    <?php
                        $progress_found = false;
                        foreach ($questions as $id => $question) {
                            if (isset($answer_counts[$id]) && $answer_counts[$id] == 1 ||$answer_counts[$id] == 2) { 
                                $progress_found = true;
                                echo '<div class="in-progress-card">';
                                echo '<h6>Question: ' . htmlspecialchars($question['question']) . '</h6>';
...
<footer id="team" class="bg-dark text-white mt-5">
    <div class="container-fulid py-4">
        <div class="row">
            <div class="col-lg-6 d-flex align-items-center mb-3">
                <div class="team-member">
                    <img src="karthik1.jpg" alt="Karthik Ujgiri" class="team-img">
                    <div class="team-info">
                        <h5 class="team-name">Karthik Ujgiri</h5>
                        <p class="team-role">Team leader & project developer</p>
                        <p class="team-description">karthik is founder of project. Worked on frontend and middleware with PHP</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 d-flex align-items-center mb-3">
                <div class="team-member">
                    <img src="chakri.jpg" alt="Chakri Shabad" class="team-img">
                    <div class="team-info">
                        <h5 class="team-name">Chakri Shabad</h5>
                        <p class="team-role">Team leader & project developer</p>
                        <p class="team-description">Chakri is also founder of project. Worked on backend and middleware with PHP</p>
                    </div>
                </div>
            </div>
        </div>
